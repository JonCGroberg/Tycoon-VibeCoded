      ...
      <Tabs defaultValue={defaultTab} value={activeTab} className="w-full " onValueChange={setActiveTab}>
        ...
        <TabsContent value="info" className="p-4 pt-2">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs text-gray-600">
                {business.type === BusinessType.RESOURCE_GATHERING ? "None" : business.inputResource}
              </span>
              <span
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs text-gray-600">{business.outputResource}</span>
              <span
                className={`text-xs font-medium ${getBufferStatusColor(
          ...
          <div className="grid grid-cols-2 gap-4 mt-4 mb-2">
            <div>
              ...
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  // onHireDeliveryBot(business.id);
                }}
              >
                Hire Driver ({getWorkerCost(business)})
              </Button>
            </div>
          </div>
        </TabsContent>
